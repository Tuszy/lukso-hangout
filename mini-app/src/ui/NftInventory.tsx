...
function NftInventory() {
  ...
  if (assetPreview !== null) {
    return (
      <div className="fixed inset-0 flex flex-col items-center justify-center select-none p-4 backdrop-blur-md">
        <div
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center select-none p-4 backdrop-blur-md">
      ...
      >
        ...
        <div className="h-80 w-[85vw] flex-grow flex-shrink flex">
